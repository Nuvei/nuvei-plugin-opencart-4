...
$_['error_nuvei_no_plan_id']    = 'Nuvei Plugin configuration missing Payment Plan ID. Please contact the site Administrator!';

$_['error_order_id']            = 'No order ID in the session!';
$_['error_payment_method']      = 'Payment method is incorrect!';
$_['error_missing_tr_id']       = 'Error - missing Transaction ID!';
